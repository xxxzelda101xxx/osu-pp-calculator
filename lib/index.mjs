import { BeatmapInfo, HitType, Beatmap, ScoreInfo, MathUtils, ScoreRank, StrainSkill, Score } from 'osu-classes';
import { TaikoDifficultyCalculator, TaikoRuleset, TaikoDifficultyAttributes, Peaks } from 'osu-taiko-stable';
import { StandardDifficultyCalculator, StandardRuleset, StandardDifficultyAttributes } from 'osu-standard-stable';
import { CatchDifficultyCalculator, JuiceDroplet, JuiceFruit, JuiceTinyDroplet, CatchRuleset, CatchDifficultyAttributes } from 'osu-catch-stable';
import { ManiaDifficultyCalculator, ManiaRuleset, ManiaDifficultyAttributes } from 'osu-mania-stable';
...
class ExtendedCatchDifficultyCalculator extends CatchDifficultyCalculator {
  constructor() {
    super(...arguments);
    this._skills = [];
  }
